...
Program Integration: Participating in the AI4ALL Summer Lab provided us with a supportive environment to tackle this project, offering resources that range from computational tools to expert mentorship. This program helped us not only in developing technical skills but also in understanding the broader impact of our work on society, emphasizing the importance of ethical considerations in AI development.
...
Integrated and Cleaned a Massive Dataset:
...
Developed a Robust Machine Learning Model:
...
Identified Key Ingredients Influencing Recipe Popularity:
...
Validated Model Predictions with Real-User Feedback:
...
Access it here: Recipe Ingredients Dataset on Kaggle
Web Scraping:
...
Explore the database: USDA National Nutrient Database
Open Data Portals:
